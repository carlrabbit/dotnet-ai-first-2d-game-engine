...
Our planning task is to create an implementation-ready milestone package for:
...
Use this as the default AI-first implementation mode when design authority is sufficiently stable.

Prefer medium-to-large coherent vertical slices rather than tiny human-sized tasks.
