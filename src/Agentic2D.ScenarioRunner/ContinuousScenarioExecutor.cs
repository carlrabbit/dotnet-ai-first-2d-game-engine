...
public static class ContinuousScenarioExecutor
{
    ...
    private sealed class Collector(List<ContinuousMoveIntent> values) : IIntentEmitter { public void Emit(MoveIntent intent) { } public void Emit(ContinuousMoveIntent intent) => values.Add(intent); }
}
